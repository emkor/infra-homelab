...
openstack quota set --instances 80 --key-pairs 40 --floating-ips 40 --cores 40 --ram 40960 --gigabytes 400 --volumes 40 --per-volume-gigabytes 40 --snapshots 40 --secgroups 40 --secgroup-rules 160 development
